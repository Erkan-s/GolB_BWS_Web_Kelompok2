        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-write"></i>Artikel </a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-heart"></i>Konten </a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-id-badge"></i>Pengarang</a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-list"></i>Tipe</a>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-user"></i>Pengguna</a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="images/Logo-Web.png" alt="Logo"></a>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2021 Be Healthy
                    </div>
